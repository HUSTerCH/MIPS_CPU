...
#
# Generated by export_simulation on Tue Mar 28 11:03:41 +0800 2023
#
################################################################################
...
'-reset_run' switch to the './iromIP.sh' script.
...
./iromIP.sh -noclean_files

For more information on the script, please type './iromIP.sh -help'.
