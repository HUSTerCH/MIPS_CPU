...
#
# Generated by export_simulation on Mon Mar 27 20:14:30 +0800 2023
#
################################################################################
...
'-reset_run' switch to the './dramIP.sh' script.
...
./dramIP.sh -noclean_files

For more information on the script, please type './dramIP.sh -help'.
